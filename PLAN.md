...
Поле в котором пишется лот для ордера ее нужно чуть улучшить цена должна быть в центре а в двух ее сторонах будут кнопки на поле не возможно будет писать не больше 3 то есть 333 или 3.33 это правильно а 4444 или 0.004 это неправильно ! на правом стороне будут кнопки +0.01 и +0.05 и выпадающий меню в котором будут быстрые кнопки +1 и +10 и +20 точно также зеркально то есть на - 
