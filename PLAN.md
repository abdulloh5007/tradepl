...
1. Если нажать на стрелку на карточке аккаунта там же открывается окно вот это окно нуно исправить чтобы оп показывал реальные данные, а не фиксированные выбери правильный путь или скажи мне варианты я выберу или ты скажи с их плюсами или минусами !

2. Почему то окно открытия аккаунтов там пропал свапер и все карточки стали по вертикали нужно исправить и убрать внизу текст "Contract specifications

Full breakdown of instrument terms, costs, and trading hours." оставить только кнопку

3. Новая логика аутентификации теперь мы подключим телеграм к приложению то есть апи телеграм мини апп и сделаем так при открытии приложения через тг то сразу делаем аутентификацию пользователя и отправим на аккаунты а на странице профиля будут его обычные данные как фото имя больше ничего и там будет кнопка настроек который откроет окно (похожий на окно на странице аккаунтов) где будут настройки языка темы и т.д