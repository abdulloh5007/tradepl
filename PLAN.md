...
1. Новая логика мне нужна твоя помощь и идея смотри короче хочу добавить новые функции такие как если трейдить какое то кол-во обемом то есть лотом и/или средств таким образом тоже можно будет получить бонус будут несколько этапа вот незнаю как их назвать чтобы они не получились похожими на названия в других местах во и нужно придумать сколько этапов будет и какая награда будет 


1. На окне KYC там сделай чтобы поле дравдовн был как наш стиль который мы делали глобальный. Потом поле где загружает картину там должно быть два поля внутри с иконками который якобы показывает переднюю часть айди и на втором в центре карточки тоже будет иконка который якобы показывает заднюю часть id или паспорта там убери поле дополнительное notes она не нужна. Контент поле который пишется айди (AD1234567) его сделай форматированным то есть еси писать AD то внутри поле поставиться автоматический пробел и | и еще пробел и здесь будет числа
Если не понял что то то спроси не мучай себя 