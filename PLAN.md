...
бро проверь работает ли функция (d)bxdepstm-(7чисел+букв) который авто пополнял баланс при сливе если убыток был больше чем баланс и на UI тоже проверь на странице историях ? 
