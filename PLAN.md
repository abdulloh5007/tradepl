...
1. Проверь уведомления о маргин калл почему то они не вызываются то есть ранее в моем счете закрылся 15+- ордеров из маргин калл и должно было прийти на странице уведомлений об маргин калл и сколько ордеры были закрыты если можно при нажатии на уведомления открыть окно об полном информации когда был закрыт почему закрыт в каком балансе был закрыт сколько ордеры были закрыты сколько общий убыток и внизу тип что если убыток будет тп чп то автоматически будет закрыться ордера короче ты понял меня UI тоже красивый должен быть будь внимателен !