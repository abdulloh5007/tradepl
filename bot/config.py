...
REVIEW_ACCESS_SYNC_SECONDS = int(os.getenv('BOT_REVIEW_ACCESS_SYNC_SECONDS', '30'))
REVIEW_CHAT_LINK_TTL_SECONDS = int(os.getenv('BOT_REVIEW_CHAT_LINK_TTL_SECONDS', '600'))
